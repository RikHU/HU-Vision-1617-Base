...
int main(int argc, char * argv[]) {
	...
	ImageIO::debugFolder = "C:\\Users\\maart\\on_the_edge\\debug";
	...
	if (!ImageIO::loadImage("C:\\Users\\maart\\on_the_edge\\testsets\\Set A\\TestSet Images\\child-1.png", *input)) {
...
bool executeSteps(DLLExecution * executor) {
	...
	auto t2 = Clock::now();
	std::cout << "Timer edge detection: " << std::chrono::duration_cast<std::chrono::milliseconds>(t2 - t1).count() << "miliseconds\n";
	...
	t2 = Clock::now();
	std::cout << "Timer threshholding: " << std::chrono::duration_cast<std::chrono::milliseconds>(t2 - t1).count() << "miliseconds\n";
